...
{
    $items=[['https://portal.metalrubber.cl','home','Portal Metalrubber','portal'],['panel.php','home','Escritorio','home'],['index.php','edit','Registrar mantención','registro'],['escanear.php','scan','Escanear QR','escaner'],['historial.php','history','Ver historial','historial']];
