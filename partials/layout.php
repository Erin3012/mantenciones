...
{
    ob_start(function(string $output): string { $home='<a class="nav-item portal-home" href="https://portal.metalrubber.cl" title="Volver al Portal Metalrubber" aria-label="Volver al Portal Metalrubber">'.layout_icon('home').'<span>Portal Metalrubber</span></a>'; return str_replace('<nav aria-label="NavegaciÃ³n principal">',$home.'<nav aria-label="NavegaciÃ³n principal">',$output); });
